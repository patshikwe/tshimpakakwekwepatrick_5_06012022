...
const productSelect = async () => {
  ...
  document.querySelector(
    ".item__content__titlePrice > h1#title"
  ).innerHTML = `${product.name}`;

  document.querySelector(
    ".item__content__titlePrice > p > span#price"
  ).innerHTML = `${product.price}`;

  document.querySelector(
    ".item__content__description > p#description"
...
function addProduct(product) {
  ...
  // ---- Suppresion du price dans product --------
  delete product.price;

  // ----- Écouter bouton ajouter ------------------
